...
export const NavMenu = ({ currentView, setCurrentView }) => {
  ...
  return (
    <nav className='navmenu'>
      ...
      <li className={currentView === 'home' ? 'selected navmenu-list-item' : 'navmenu-list-item'}><button className='selected' onClick={() => { handleBtnClick('home') }}> <FontAwesomeIcon style={{ marginRight: '10px' }} icon={faHouse} /></button></li>
        <li className={currentView === 'favorites' ? 'selected navmenu-list-item' : 'navmenu-list-item'}><button onClick={() => { handleBtnClick('favorites') }}> <FontAwesomeIcon style={{ marginRight: '10px' }} icon={faHeart} /></button></li>
        <li className={currentView === 'toread' ? 'selected navmenu-list-item' : 'navmenu-list-item'}><button onClick={() => { handleBtnClick('toread') }}> <FontAwesomeIcon style={{ marginRight: '10px' }} icon={faBookOpen} /></button></li>
        <li className={currentView === 'finished' ? 'selected navmenu-list-item' : 'navmenu-list-item'}><button onClick={() => { handleBtnClick('finished') }}> <FontAwesomeIcon style={{ marginRight: '10px' }} icon={faCircleCheck} /></button></li>
        <li className={currentView === 'search' ? 'selected navmenu-list-item' : 'navmenu-list-item'}><button onClick={() => { handleBtnClick('search') }}> <FontAwesomeIcon style={{ marginRight: '10px' }} icon={faMagnifyingGlass} /></button></li>

        <a href="/">
          <li className={currentView === 'signout' ? 'selected navmenu-list-item' : 'navmenu-list-item'}><button onClick={() => { handleBtnClick('signout') }}> <FontAwesomeIcon style={{ marginRight: '10px' }} icon={faSignOut} /></button></li>
        </a>
      </ul>
    </nav>
  )
