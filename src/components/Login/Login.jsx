        ...
        <section style={{ margin: '5% 0'}}>
            <div className="card mb-3 login-general-card" style={{ backgroundColor: '#2e0000', color: 'white', boxShadow: 'rgba(0, 0, 0, 0.35) 0px 5px 15px' }}>
                <div className="row g-0">
                    <div className="col-md-5 image-login-container">
                        <img src={GirlWithBooks} className="img-fluid rounded login-image" alt="girl-with-books-stack" loading='eager' />
                    </div>
                            ...
                            {({ isSubmitting }) => (
                                <Form className='login-form'>
                                    <div className="form-group">
                                        ...
                                        <Field type="email" name="email" className="form-control" id="loginInputEmail" aria-describedby="emailHelp" placeholder="Enter email" />
